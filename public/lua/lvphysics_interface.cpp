...
LUA_API void lua_pushsurfacesoundnames (lua_State *L, lua_surfacesoundnames_t *psounds) {
  lua_newtable(L);
  lua_pushstring(L, physprops->GetString(psounds->stepleft));
  lua_setfield(L, -2, "stepleft");
  lua_pushstring(L, physprops->GetString(psounds->stepright));
  lua_setfield(L, -2, "stepright");

  lua_pushstring(L, physprops->GetString(psounds->impactSoft));
  lua_setfield(L, -2, "impactSoft");
  lua_pushstring(L, physprops->GetString(psounds->impactHard));
  lua_setfield(L, -2, "impactHard");

  lua_pushstring(L, physprops->GetString(psounds->scrapeSmooth));
  lua_setfield(L, -2, "scrapeSmooth");
  lua_pushstring(L, physprops->GetString(psounds->scrapeRough));
  lua_setfield(L, -2, "scrapeRough");

  lua_pushstring(L, physprops->GetString(psounds->bulletImpact));
  lua_setfield(L, -2, "bulletImpact");
  lua_pushstring(L, physprops->GetString(psounds->rolling));
  lua_setfield(L, -2, "rolling");

  lua_pushstring(L, physprops->GetString(psounds->breakSound));
  lua_setfield(L, -2, "breakSound");
  lua_pushstring(L, physprops->GetString(psounds->strainSound));
